...
describe('visual/v2-shell', () => {
  for (const fixture of fixtures) {
    it(`captures the ${fixture} shell fixture`, () => {
      const { getByTestId } = render(() => <Shell nav={createNavStore()}><div data-testid="fixture-body" data-fixture={fixture} /></Shell>)
      expect(getByTestId('window')).toBeTruthy()
      expect(getByTestId('project-rail')).toBeTruthy()
      expect(getByTestId('fixture-body').getAttribute('data-fixture')).toBe(fixture)
    })
  }
})
