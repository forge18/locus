...
/**
 * Structural conformance against screenshots 10, 11, 12 and 13 — not a pixel
...
describe('visual: workshop', () => {
  it('has all four reference screenshots to conform to', () => {
    for (const shot of [
      '10-workshop-extensions.png',
      '11-workshop-agent-definitions.png',
      '12-workshop-workflow.png',
      '13-workshop-harnesses.png',
    ]) {
  ...
  it('lights Workshop with three tabs, and no Agents tab among them', () => {
    const { getByTestId } = mount('extensions', () => <ExtensionsView onNavigate={() => {}} />)
  ...
  it('carries the copy the screenshots show, verbatim', () => {
    const extensions = mount('extensions', () => <ExtensionsView onNavigate={() => {}} />)
