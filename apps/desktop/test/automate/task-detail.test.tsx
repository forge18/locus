...
describe('automate/task-detail', () => {
  it('shows workflow, root session, run tree, evidence, and controls', () => {
    ...
    expect(getByTestId('automate-task-detail').textContent).toContain('Workflow')
    expect(getByTestId('automate-task-detail').textContent).toContain('Root session')
    expect(getByTestId('automate-task-detail').textContent).toContain('Evidence')
