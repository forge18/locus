...
describe('automate/create-task-parity', () => {
  it('uses one draft contract for both entry points', async () => {
    ...
    expect(kanbanDraft.getAttribute('data-draft-contract')).toBe(listDraft.getAttribute('data-draft-contract'))
    expect(kanbanDraft.querySelector('input')?.getAttribute('placeholder')).toBe(listDraft.querySelector('input')?.getAttribute('placeholder'))
  })
})
