...
describe('status/no-query-tool', () => {
  it('keeps search and facet controls out of Status', () => {
    const { getByTestId, queryByTestId, queryByPlaceholderText } = render(() => <AnalyticsView />)
    ...
    expect(queryByPlaceholderText('BM25 search over the normalized event log')).toBeNull()
  })
})
