...
describe('canvas/inspector', () => {
  it('shows the compiled deterministic condition expression', () => {
    ...
    expect(getByTestId('wf-compiled-expr').textContent).toContain('verify.passed')
    expect(getByTestId('wf-compiled-note').textContent).toContain('evaluable in the core')
  })
})
