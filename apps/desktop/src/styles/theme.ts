...
export function applyTheme(documentElement: Pick<HTMLElement, 'dataset'>, theme: string | null | undefined): ThemeId {
  const resolved = normalizeTheme(theme)
  documentElement.dataset.theme = resolved
  return resolved
}

export function persistTheme(storage: Pick<Storage, 'setItem'>, documentElement: Pick<HTMLElement, 'dataset'>, theme: string): ThemeId {
