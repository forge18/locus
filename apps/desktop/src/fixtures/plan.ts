...
export interface PlanSummary {
  ...
  project: string
  state: PlanState
  /** Which of the eight it is on. The breadcrumb derives its states from this. */
  step: PlanStep
  /** The step line the card shows, e.g. "step 5 · audit". */
  stepLine: string
...
export const RECOMMENDATION: Recommendation = {
  confidence: 0.62,
  open: 2,
  condition: 'high once the provenance tie-break and the decay interaction are settled',
...
export const ONE_APPROVAL_RULE = 'Nothing reaches the board until one approval at the end.'
