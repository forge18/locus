...
export const TASKS: Task[] = [
  ...
  { id: 't-009', projectId: 'p-tapestry', repoId: 'r-tapestry-app', title: 'Notification plan', column: 'waiting_for_approval', status: 'ok', verifyCommand: 'cargo test -p tapestry-core notify::', assignee: 'planner@3', gate: 'human', stuckIterations: null, maxIterations: 3, tools: 'read-only tools', tokens: null },
  { id: 't-010', projectId: 'p-weaver', repoId: 'r-weaver-docs', title: 'Regenerate the CLI reference', column: 'done', status: 'ok', verifyCommand: 'pnpm -C weaver-docs test', assignee: 'ingest@2', gate: 'reviewer agent', stuckIterations: null, maxIterations: 3, tools: 'read-only tools', tokens: null },
]
