...
export const Desktop_INBOX_ITEMS = [
  {
    kind: 'gate',
...
export const Desktop_RUNNING_PROJECTS = [
...
export const Desktop_TOKEN_DAYS = [
...
export const Desktop_MODEL_SCORECARD = [
...
export const Desktop_DASHBOARD_COUNTERS = [
