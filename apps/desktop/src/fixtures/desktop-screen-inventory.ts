...
export interface DesktopFixtureRoute {
  /** Stable route identity; the desktop navigation resolver will consume it in task 4. */
  id: string
  label: string
  scope: FixtureScope
  /** Screenshot stem in `docs/design_handoff_locus_desktop/screenshots/`. */
  screen: string
  screenshot: string
}
...
/**
 * The delivered desktop fixture inventory, in the handoff's navigation order.
 *
 * This deliberately describes routes before the desktop shell replaces the v1
