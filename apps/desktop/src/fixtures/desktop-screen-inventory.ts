...
export const Desktop_FIXTURE_ROUTES = Object.freeze([
  ...
  fixtureRoute("short", "Short-term", "project", "memory"),
  fixtureRoute("memory", "Long-term", "project", "memory"),
  fixtureRoute("artifact", "Artifacts", "project", "memory"),
  fixtureRoute("wiki", "Wiki", "project", "memory"),
