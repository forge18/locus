...
export const VIEWS = Object.freeze(Desktop_FIXTURE_ROUTES.map((route) => route.id))
...
export const RAIL_ITEMS: readonly RailItem[] = Object.freeze([
  ...
  { category: 'interact', label: 'Interact', icon: 'chat-circle', firstView: 'interact' },
  { category: 'review', label: 'Review', icon: 'check-square', firstView: 'qa' },
  { category: 'analytics', label: 'Analytics', icon: 'chart-bar', firstView: 'status' },
  { category: 'memory', label: 'Memory', icon: 'brain', firstView: 'short' },
  { category: 'settings', label: 'Settings', icon: 'sliders', firstView: 'settings' },
  { category: 'workshop', label: 'Workshop', icon: 'wrench', firstView: 'agents' },
