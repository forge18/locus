...
export const DESKTOP_ROUTES = Object.freeze([
  ...
  desktopRoute("short", "Short-term", "project", "knowledge"),
  desktopRoute("memory", "Long-term", "project", "knowledge"),
  desktopRoute("artifact", "Artifacts", "project", "knowledge"),
  desktopRoute("wiki", "Wiki", "project", "knowledge"),
