...
function MemoryFrame(props: { testId: string; route: string; contextLayers?: string; compaction?: string; children: JSX.Element }) {
  return (
...
export function MemoryShortTermFixture() {
  return (
    <MemoryFrame testId="v2-memory-short-term" route="memory-short-term" contextLayers="resident" compaction="artifact-handles">
