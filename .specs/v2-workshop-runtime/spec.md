...
**Milestone** M0.6 · **Depends on** `v2-application-shell`, `theme-system` · **Blocks** M1 runtime
configuration and M4 workflow execution.

## Purpose

Make v2 Workshop configuration real: providers, Minisign-verified CLI tools, adapter-gated harnesses,
