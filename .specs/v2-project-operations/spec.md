...
**Milestone** M0.6 · **Depends on** `v2-application-shell` · **Blocks** M1/M3/M5 project runtime work.

## Purpose

Deliver the v2 project, planning, Automate, and Dispatch contracts rather than treating their screens
...
Dispatch owns queue policy, caps, preemption-at-boundary, autorun, schedules, Stop all, and bounded
restore. Automate renders project cards/agents from that durable state.
