# desktop-knowledge-review — tasks

| # | Task | Deps | verify |
| --- | --- | --- | --- |
| 1 | Add global Inbox desktop route and fixtures | — | `pnpm -C apps/desktop test -- inbox/desktop-route` |
| 2 | Render action-required and completed inbox groups | 1 | `pnpm -C apps/desktop test -- inbox/desktop-groups` |
...
| 5 | Add global Dashboard desktop route and fixtures | — | `pnpm -C apps/desktop test -- dashboard/desktop-route` |
...
| 9 | Add selected-project Develop route | — | `pnpm -C apps/desktop test -- develop/desktop-route` |
...
| 30 | Capture Dark/Light visual regressions for all viewer routes | 28 | `pnpm -C apps/desktop test -- visual/desktop-viewers` |
