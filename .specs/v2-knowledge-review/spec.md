...
**Milestone** M0.6 · **Depends on** `v2-application-shell`, `theme-system` · **Blocks** M2–M6 viewers.

## Purpose

Replace v1 Review/Wiki fixtures with v2 Develop, Memory, Review, Inbox, and Dashboard viewers. These
