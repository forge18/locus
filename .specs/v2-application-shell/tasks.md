# v2-application-shell — tasks

| # | Task | Deps | verify |
| --- | --- | --- | --- |
| 1 | Register global and project-scoped v2 route kinds | — | `pnpm -C apps/desktop test -- nav/v2-route-kinds` |
...
| 5 | Build the 42px v2 title bar | — | `pnpm -C apps/desktop test -- shell/v2-titlebar` |
| 6 | Render current category and view labels | 5 | `pnpm -C apps/desktop test -- shell/v2-title-labels` |
...
| 19 | Add locator and Cmd-K entry point | 1,5 | `pnpm -C apps/desktop test -- nav/v2-locator` |
...
| 28 | Capture visual regression fixtures for shell states | 8,18,26 | `pnpm -C apps/desktop test -- visual/v2-shell` |
