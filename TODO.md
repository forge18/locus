...
| **M0.6** | v2 desktop reconciliation | 6 | 195 | 37 |
...
- [x] **[design-v2](.specs/design-v2/spec.md)** · 24 tasks · **complete** · [tasks](.specs/design-v2/tasks.md)
  ...
  *Depends on:* M0.5
- [ ] **[theme-system](.specs/theme-system/spec.md)** · 8 tasks · **3/8 complete** · [tasks](.specs/theme-system/tasks.md)
...
- [ ] **[v2-application-shell](.specs/v2-application-shell/spec.md)** · 28 tasks · **10/28 complete** · [tasks](.specs/v2-application-shell/tasks.md)
