...
- [ ] **[acp-client](.specs/acp-client/spec.md)** · 13 tasks · **8/13 complete** · [tasks](.specs/acp-client/tasks.md)
...
- [ ] **[run-supervisor](.specs/run-supervisor/spec.md)** · 22 tasks · **4/22 complete** · [tasks](.specs/run-supervisor/tasks.md)
