...
- [ ] **[agent-cli](.specs/agent-cli/spec.md)** · 24 tasks · **9/24 complete** · [tasks](.specs/agent-cli/tasks.md)
...
- [ ] **[run-supervisor](.specs/run-supervisor/spec.md)** · 22 tasks · **3/22 complete** · [tasks](.specs/run-supervisor/tasks.md)
