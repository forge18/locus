mod harness {
    ...
    #[test]
    fn defaults() {
        let defaults = RoutingDefaults { model_id: "opus".into(), effort: "high".into() };
        let harness = HarnessDescriptor { identifier: "claude".into(), adapter: None, compatible_providers: BTreeSet::new(), defaults: defaults.clone() };
